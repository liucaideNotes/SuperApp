...
/*
 ...
 3,如需自定义刷新控件的文字或图片可在FH_MJRefreshDatas类中设置
 4,FH_MJDIYHeader 类用于完全自定义下拉头部View
   FH_MJDIYAutoFooter、FH_MJDIYBackFooter 两个类用于完全自定义上拉底部View
   可在类中自由编写
 4,使用
...
extension UIScrollView {
    //MARK:----------- 添加顶部刷新 -- 普通
    func headerAddMJRefresh(_ block:@escaping MJRefreshComponentRefreshingBlock)  {
    ...
    //MARK:----------- 添加顶部刷新 -- 动态
    func headerAddMJRefreshGif(_ block:@escaping MJRefreshComponentRefreshingBlock)  {
    ...
    func headerAddMJRefreshDIY(_ block:@escaping MJRefreshComponentRefreshingBlock) {
        self.mj_header = FH_MJDIYHeader(refreshingBlock: block)
    }
    //MARK:----------- 调用顶部刷新
...
extension UIScrollView {
    //MARK:-- 添加底部刷新 -- 普通自动刷新
    func footerAddMJRefresh_Auto(_ block:@escaping MJRefreshComponentRefreshingBlock) {
    ...
    //MARK:-- 添加底部刷新 -- 普通手动刷新
    func footerAddMJRefresh_Back(_ block:@escaping MJRefreshComponentRefreshingBlock) {
    ...
    //MARK:-- 添加底部刷新 -- 动态自动
    func footerAddMJRefreshGif_Auto(_ block:@escaping MJRefreshComponentRefreshingBlock) {
    ...
    //MARK:-- 添加底部刷新 -- 动态手动
    func footerAddMJRefreshGif_Back(_ block:@escaping MJRefreshComponentRefreshingBlock) {
    ...
    func footerAddMJRefreshDIY_Auto(_ block:@escaping MJRefreshComponentRefreshingBlock) {
        self.mj_footer = FH_MJDIYAutoFooter(refreshingBlock: block)
    }
    //MARK:-- 添加底部刷新 -- 完全自定义手动刷新
    func footerAddMJRefreshDIY_Back(_ block:@escaping MJRefreshComponentRefreshingBlock) {
        self.mj_footer = FH_MJDIYBackFooter(refreshingBlock: block)
    }
