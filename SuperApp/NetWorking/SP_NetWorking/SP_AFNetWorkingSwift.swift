...
open class SP_AFNetWorkingSwift {
    fileprivate static let sharedInstance = SP_AFNetWorkingSwift()
    fileprivate init() {}
    //提供静态访问方法
    open static var shared: SP_AFNetWorkingSwift {
    ...
    fileprivate lazy var _manager:AFHTTPSessionManager = {
        ...
        //mana.securityPolicy = self.mySecurityPolicy
    ...
    private lazy var mySecurityPolicy: AFSecurityPolicy =  {
        ...
        let cerPath:String = Bundle.main.path(forResource: "https.iex.com", ofType: "cer")!
    ...
    //MARK:---- get 请求
    func get(_ url:String, block:@escaping NetworkFinished) {
    ...
    //MARK:---- post 请求
    func post(_ url:String, param:[String:Any], block:@escaping NetworkFinished) {
        if self.netWorkReachability() {
    ...
    //MARK:---- 上传
    func upload(_ url:String, param:[String:Any], uploadParams:[SP_UploadParam], progress:@escaping NetworkProgress, block:@escaping NetworkFinished) {
    ...
    //MARK:---- 下载
    func downLoad(_ url:String, param:[String:Any], progress:@escaping NetworkProgress, block:@escaping NetworkFinished) {
